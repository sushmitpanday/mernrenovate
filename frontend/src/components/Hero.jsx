          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100/80 p-6 sm:p-8 w-full relative">
            ...
            {activeTab === "work" ? (
              <div className="space-y-4">
                ...
                <button onClick={() => navigate("/hire-trade")} className="w-full flex items-center justify-between p-4 bg-white border border-gray-100 rounded-2xl hover:border-orange-200 hover:shadow-lg transition-all duration-300 text-left group">
